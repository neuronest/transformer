...
class NormalizationLayer(nn.Module):
    ...
    def __init__tmp(self, dim_word):
        from torch.nn.modules.normalization import LayerNorm
        self.layer_norm = LayerNorm(dim_word)


    def forward_tmp(self, Z):
...
class Transformer(nn.Module):
    def __init__(
        ...
        from torch.nn.modules import transformer as PytorchTransformer
    ...
    def forward(self, input_encoder, input_decoder, mask_decoder=None, pytorch_transformer=True):
    ...
    def train_on_batch(self, input_encoder, input_decoder, target, mask_decoder=None, pytorch_transformer=True):
